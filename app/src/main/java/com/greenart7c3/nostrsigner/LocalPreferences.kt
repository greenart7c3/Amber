...
object LocalPreferences {
    ...
    suspend fun saveToEncryptedStorage(
        ...
        prefs.edit {
            apply {
                ...
                putBoolean(PrefKeys.BACKUP_APPLICATIONS.key, account.backupApplications)
            }
        }
    ...
    suspend fun loadFromEncryptedStorage(context: Context, npub: String): Account? {
        ...
        sharedPrefs(context, npub).apply {
            ...
            val backupApplications = getBoolean(PrefKeys.BACKUP_APPLICATIONS.key, false)
            ...
            val account =
                Account(
                    ...
                    didBackup = didBackup,
                    backupApplications = backupApplications,
                )

    ...
    fun toLocalizedString(context: Context, shouldTranslateConnect: Boolean = false): String = when (type.trim()) {
        ...
        "sign_event" -> {
            when (kind) {
                ...
                20001 -> context.getString(R.string.event_kind_20001)
                20002 -> context.getString(R.string.event_kind_20002)
                ...
                25742 -> context.getString(R.string.event_kind_25742)
                3063 -> context.getString(R.string.event_kind_3063)
                3314 -> context.getString(R.string.event_kind_3314)
                3367 -> context.getString(R.string.event_kind_3367)
                40003 -> context.getString(R.string.event_kind_40003)
                41010 -> context.getString(R.string.event_kind_41010)
                ...
                45001 -> context.getString(R.string.event_kind_45001)
                45002 -> context.getString(R.string.event_kind_45002)
                45003 -> context.getString(R.string.event_kind_45003)
                ...
                9008 -> context.getString(R.string.event_kind_9008)
                9009 -> context.getString(R.string.event_kind_9009)
                9010 -> context.getString(R.string.event_kind_9010)
                9021 -> context.getString(R.string.event_kind_9021)
                9022 -> context.getString(R.string.event_kind_9022)
                ...
                9450 -> context.getString(R.string.event_kind_9450)
                ...
                13303 -> context.getString(R.string.event_kind_13303)
                ...
                24450 -> context.getString(R.string.event_kind_24450)
                ...
                33302 -> context.getString(R.string.event_kind_33302)

...
import com.greenart7c3.nostrsigner.service.model.EventInterface
import com.greenart7c3.nostrsigner.service.model.RelayAuthEvent
...
class Relay(
    ...
    fun processNewRelayMessage(newMessage: String) {
        ...
        when (type) {
            "EVENT" -> {
                val event = Event.fromJson(msgArray[2], false)

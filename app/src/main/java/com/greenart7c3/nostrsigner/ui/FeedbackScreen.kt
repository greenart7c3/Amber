            ...
            onClick = {
                Amber.instance.applicationIOScope.launch {
                    try {
                        ...
                        if (result) {
                            accountStateViewModel.toast(Amber.instance.getString(R.string.warning), Amber.instance.getString(R.string.feedback_sent))
                            onLoading(false)
                            onDismiss()
                        } else {
                            accountStateViewModel.toast(Amber.instance.getString(R.string.warning), Amber.instance.getString(R.string.failed_to_send_event))
                            onLoading(false)
                        }
                    } catch (e: Exception) {
                        onLoading(false)
